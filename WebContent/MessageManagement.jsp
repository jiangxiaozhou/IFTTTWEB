...
<body>
	...
	<div class="banner-info">
		<form action=manageMessage method="post">
			<h4>公共消息</h4>
			<%
				...
				for (int i = 0; i < count; i++) {
					...
					out.print("<div class=\"Message\"><ul><h1><li>" + m.getContent() + "</li></h1><h5><li>来自："
							+ m.getSourceid() + "</li><li><pre> </pre></li><li>时间：" + m.getTime() + "</li></h5></ul></div>");
				}
			%>
			<h4>私人消息</h4>
			<%
