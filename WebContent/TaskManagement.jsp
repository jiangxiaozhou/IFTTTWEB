	...
	<div class="banner-info">
		<form method="post" action="getTask">
			<div class="ThisThatChoose">
				<ul>
					<li>
						<h1>任务名</h1> <input type="text" name="taskname" id="taskname">
					</li>
					<li><pre>        </pre></li>
					<li>
						<h1>THIS</h1>
						<h3>
							<input type="radio" value=0 checked="checked" name="this"
								id="timeTrigger" onchange="showTimeThis()"> 定时发送 <input
								type="radio" value=1 name="this" id="MailTrigger"
					...
					<li>
						...
						<h3>
							<input type="radio" checked="checked" name="that" id="MailAction"
								onchange="showMailThat()" value=1> 邮件 <input
